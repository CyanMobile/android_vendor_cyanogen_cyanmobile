...
PRODUCT_COPY_FILES += \
    ...
    vendor/cyanogen/prebuilt/common/etc/init.d/apps2sd:system/bin/apps2sd \
    vendor/cyanogen/prebuilt/common/etc/init.d/sdextcache:system/bin/sdextcache \
...
ifdef CYANOGEN_WITH_GOOGLE
    ...
    PPRODUCT_COPY_FILES += $(shell find vendor/cyanogen/proprietary -name '*.jar' \
